...
export default function TwitterImage() {
  return new ImageResponse(
    (
      ...
      >
        {/* Aureate radial glow — upper center */}
        <div
          style={{
            position: 'absolute',
            left: 100,
        ...
        {/* Topo lines — extended for taller canvas */}
        {[
          { y: 264, o: 0.04 },
          { y: 284, o: 0.05 },
          { y: 306, o: 0.07 },
        ...
        <svg
          ...
          fill="none"
        >
          {/* Outer corner brackets — 35px margin, 105px arms */}
          <g stroke={FRAME_GRAY} strokeWidth="2" strokeLinecap="square" strokeLinejoin="miter">
            ...
            <path d="M 1060 640 L 1165 640 L 1165 535" />
            <path d="M 140 640 L 35 640 L 35 535" />
          </g>
          {/* Aureate accent brackets — 80px offset, 75px arms */}
          <g stroke={AUREATE_400} strokeWidth="1.5" strokeLinecap="square" strokeLinejoin="miter" opacity="0.45">
            ...
            <path d="M 1045 595 L 1120 595 L 1120 520" />
            <path d="M 155 595 L 80 595 L 80 520" />
          </g>
        ...
        {/* Centered content block — same composition as OG */}
        <div
          style={{
            position: 'absolute',
            top: 270,
